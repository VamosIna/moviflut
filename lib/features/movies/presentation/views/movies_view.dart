...
import 'package:movie_app/core/presentation/components/animation_column.dart';
    ...
    return SingleChildScrollView(
      ...
      child: AnimationColumnWidget(
        ...
        children: [
          ...
          favMovies.length != 0?
          SectionHeader(
            title: AppStrings.favouriteMovies,
            onSeeAllTap: () {
              context.goNamed(AppRoutes.favoritesListRoute);
            },
          ):SizedBox(
            height: 10,
          ),
          favMovies.length != 0 ?SectionListView(
            height: AppSize.s240,
            ...
            itemBuilder: (context, index) {
              return AnimationListWidget(
                  isVertical: false,
                  index: index,
                  child: SectionListViewCard(media: favMovies[index]));
            },
          ):SizedBox(
            height: 10,
          ),
          ...
          SectionListView(
            ...
            itemBuilder: (context, index) {
              return AnimationListWidget(
                  isVertical: false,
                  index: index,
                  child: SectionListViewCard(media: popularMovies[index]));
            },
          ),
          SectionHeader(
          ...
          SectionListView(
            ...
            itemBuilder: (context, index) {
              return AnimationListWidget(
                  isVertical: false,
                  index: index,
                  child: SectionListViewCard(media: topRatedMovies[index]));
            },
          ),
        ],
      ),
